...
describe("Function exercises", function () {
    ...
    it("calculateCirleAround", function () {
        var temp = Math.round(calculateCirleAround(6));
        expect(temp).toEqual(38);
    });
    
    // calculateCirleArea
    it("calculateCirleArea", function () {
        var temp = Math.round(calculateCirleArea(6));
    ...
    it("F9: check input data - right input", function () {
        ...
        expect(temp2).toEqual(
            "Your date is right and your are " + ikä + " years old.<br>" +
